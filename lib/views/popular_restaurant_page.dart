...
class PopularRestaurantListPage extends StatelessWidget {
  const PopularRestaurantListPage({Key? key}) : super(key: key);

  static const String routeName = '/popular_restaurant_page';
